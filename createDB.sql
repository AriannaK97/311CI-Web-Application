...
CREATE TABLE USER_ACTION_LOG(
    USER_ACTION_LOG_ID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE REQUEST_TYPE(
    REQUEST_TYPE_ID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    NAME VARCHAR(120) UNIQUE
);

CREATE TABLE EXTRA_INCIDENT_INFO(
    EXTRA_INCIDENT_INFO_ID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE STATUS_TYPE(
    STATUS_TYPE_ID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
